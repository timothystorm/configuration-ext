...
class ResourceUtils {
    ...
    public static URL getURL(String resourceLocation) throws FileNotFoundException {
        if (resourceLocation == null) throw new IllegalArgumentException("resource location required!");
        if (resourceLocation.startsWith(CLASSPATH_URL_PREFIX)) {
            String path = resourceLocation.substring(CLASSPATH_URL_PREFIX.length());
            ClassLoader cl = ClassPathUtils.getDefaultClassLoader();
    ...
    public static File getFile(URL resourceUrl, String description) throws FileNotFoundException {
        if (resourceUrl == null) throw new IllegalArgumentException("resource url required!");
    ...
    public static File getFile(URI resourceUri, String description) throws FileNotFoundException {
        if (resourceUri == null) throw new IllegalArgumentException("resource uri required!");
    ...
    public static URL extractArchiveURL(URL jarUrl) throws MalformedURLException {
        ...
        if (endIndex != -1) {
            ...
            if (startIndex != -1) { return new URL(warFile.substring(startIndex + WAR_URL_PREFIX.length())); }
        }
